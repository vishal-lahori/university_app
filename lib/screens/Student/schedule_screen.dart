...
class ScheduleScreen extends StatelessWidget {
  static final String id = 'schedule_screen';
    ...
    return Container(
      ...
      child: Row(
        children: <Widget>[
          ...
          Expanded(
            child: Text(
              "Your future is created by what you do today, not tomorrow. So go attend Your Classes.",
...
class HeaderFooterwidget extends StatelessWidget {
  ...
  const HeaderFooterwidget(
      ...
      this.footer,
      this.body,
      this.headerColor = Colors.black12,
      this.footerColor = Colors.indigo,
      this.headerHeight})
      : super(key: key);
